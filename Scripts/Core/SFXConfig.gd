...
const FILE_PATHS := {
	...
	Keys.AlpacaHurt : "res://Assets/Audio/SFX/Alpaca_Hurt.mp3",
	Keys.AlpacaAttack : "res://Assets/Audio/SFX/Alpaca_Attack.wav",
	Keys.HorseHurt : "res://Assets/Audio/SFX/Horse_Hurt.mp3",
	Keys.HorseAttack : "res://Assets/Audio/SFX/Horse_Attack.mp3",
